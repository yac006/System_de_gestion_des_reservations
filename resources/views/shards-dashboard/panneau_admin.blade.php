          ...
          <div class="main-content-container container-fluid px-4">
            ...
            <div class="row row02">
              ...
              <div class="col-lg col-md-6 col-sm-6 mb-4">
                <div class="stats-small stats-small--1 card card-small">
                  <div class="cont_icon">
                      <i class="zmdi zmdi-calendar-note zmdi-hc-5x" style="color:#c3c7cc; "></i>
                  </div>
                </div>
              </div>
              <div class="col-lg col-md-4 col-sm-6 mb-4">
                <div class="stats-small stats-small--1 card card-small">
                 <div class="cont_icon">
                      <i class="zmdi zmdi-notifications-active zmdi-hc-5x" style="color:#c3c7cc; "></i>
                  </div>
                </div>
              </div>
              <div class="col-lg col-md-4 col-sm-6 mb-4">
                <div class="stats-small stats-small--1 card card-small">
                 <div class="cont_icon">
                      <i class="zmdi zmdi-file-text zmdi-hc-5x" style="color:#c3c7cc; "></i>
                  </div>
                </div>
              </div>
              <div class="col-lg col-md-4 col-sm-12 mb-4">
                <div class="stats-small stats-small--1 card card-small">
                 <div class="cont_icon">
                      <i class="zmdi zmdi-help-outline zmdi-hc-5x" style="color:#c3c7cc; "></i>
                  </div>
                </div>
              </div>
            </div>
